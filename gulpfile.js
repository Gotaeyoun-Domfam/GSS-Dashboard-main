...
function jsLib() {
  let sourceLib = [
    ...
    'src/js/src/Chart.js',
    'src/js/src/chartjs-plugin-datalabels.js',
    'src/js/src/treeTable.js',
    'src/js/src/bootstrap-table.min.js',
    'src/js/src/swiper.min.js',
    'src/js/src/jquery.rateyo.min.js',
    'src/js/src/amchart/core.js',
    'src/js/src/amchart/charts.js',
    'src/js/src/amchart/themes/animated.js',
    'src/js/src/amchart/ko_KR.js',
  ];
...
//task
gulp.task("dev", gulp.series(setEnvDevelope, delDist, scss, copyIndex, copyImg, copyFonts, jsLib, jsLang, jsCommon, htmlPage));
